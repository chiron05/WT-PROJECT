...
<body>
    ...
    <div class="data-container">
        <div class="global-stats" style="width: 50vw; ">
            <h1>Global Crypto Stats</h1>
            <div class="stats" style="display: flex; margin-top: 30px;">
                <div >
                    <h6>Total Coins</h6>
                    <h2>
                        <?php
                            echo $res['data']['totalCoins'];
                        ?>
                    </h2>
                </div>
                <div>
                    <h6>Total Exchange</h6>
                    <h2>
                        <?php
                            echo $res['data']['totalExchanges'];
                        ?>
                    </h2>
                </div>
            </div>
            <div class="stats" style="display: flex; margin-top: 20px;">
                <div>
                    <h6>Total Market Cap</h6>
                    <h2>
                        <?php
                            echo  nice_number($res['data']['totalMarketCap']);
                        ?>
                    </h2>
                </div>
                <div>
                    ...
                    <h2>
                        <?php
                            echo nice_number($res['data']['total24hVolume']);
                        ?>
                    </h2>
                </div>
            </div>
            <div style="display: flex; margin-top: 20px; margin-left: 40px; color: rgb(90,91,92);">
                <div>
                    <h6>Bitcoin Dominance</h6>
                    <h2>
                        <?php
                            echo $res['data']['btcDominance'];
                        ?>
                    </h2>
                </div>
            </div>
        ...
        <div class="top-crypto">
            ...
            <?php
                ...
                for ($i = 0; $i < 10; $i++) {
                    $uuid = $cryptoCoinsResult['data']['coins'][$i]['uuid'];
        ...
        <div style="display: flex; justify-content: space-between; width: 70vw;">
            <h1>Top News</h1>
            <a href="../html/all_news.php" style="text-decoration: none; color: rgb(24,144,255); margin-top: 5px; font-weight: bold; font-size: larger;">SHOW MORE</a>
        </div>
